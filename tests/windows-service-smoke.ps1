...
try {
  ...
  if ($health.schema -cne 'sentinel.service-health/v1' -or $health.host_version -cne '0.2.0' -or $health.scanner -cne 'windows-powershell' -or $health.arbitrary_command_enabled -ne $false) { throw 'Service health contract mismatch' }
