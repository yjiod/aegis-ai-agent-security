...
class SentinelTests(unittest.TestCase):
    ...
    def test_client_update_policy_keeps_external_lifecycle_owner(self):
        ...
        offer={'agent_version':'0.45.0','platform_signature_verified':True,'release_signature_verified':True,'authorized_rings':['lab','pilot']}
    ...
    def test_controlled_self_update_is_fail_closed_and_content_keeps_lkg(self):
        ...
        offer={'agent_version':'0.45.0','platform_signature_verified':True,'release_signature_verified':True,'authorized_rings':['lab']}
