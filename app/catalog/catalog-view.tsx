 ...
 *
 * ─────────────────────────────────────────────────────────────
 * ✅ 生产环境门禁（已实现，方案 2：运行时守卫）
 *
 * /catalog 属于开发辅助路由，渲染的是组件走查用的示例数据（payment-service、
 * "门禁通过率 94%" 等虚构演示值），不应在生产环境对外可访问——否则违反
 * "生产控制台任何页面不得显示演示/虚构数字" 红线。
 *
...
/* ---------- 页面（客户端视图；由 app/catalog/page.tsx 服务端门禁包裹）---------- */
