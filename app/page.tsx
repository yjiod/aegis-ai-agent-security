        ...
        {view === 'onboarding' && (
          <>
            <div className="baseline-banner">
              <div>
                <h2>Sentinel Endpoint Agent {releaseMetadata?.component_versions.endpoint_agent ?? '0.47.0'}</h2>
            ...
            <div className="panel inset onboarding">
              ...
              <div className="download-actions">
                ...
                <a className="download-primary" href="https://github.com/yjiod/sentinel-ai-agent-security/releases/download/v5.9.0/Sentinel-Agent-Windows-x64-5.9.0.msi">Windows MSI 5.9</a>
                <a className="download-primary" href="https://github.com/yjiod/sentinel-ai-agent-security/releases/download/v5.9.0/Sentinel-Agent-macOS-5.9.0.pkg">macOS PKG 5.9</a>
                <a href="https://github.com/yjiod/sentinel-ai-agent-security/releases/download/v5.9.0/SHA256SUMS.txt">安装包 SHA-256</a>
