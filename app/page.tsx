        ...
        {view === 'onboarding' && (
          <>
            <div className="baseline-banner">
              <div>
                <h2>Sentinel Endpoint Agent 0.9.0</h2>
            ...
            <div className="panel inset onboarding">
              ...
              <div className="control-planes">
                ...
                <article><b><EDR_VENDOR_CN> EDR</b><span>响应处置</span><p>接收高危事件，按现网版本能力执行隔离、查杀或 IOC 取证。</p></article>
                <article><b><MDM_VENDOR_CN>桌管</b><span>资产与兜底</span><p>软件分发、资产核验及未安装终端的准入修复。</p></article>
              </div>
              <ol><li><b>自动发现</b><span>Intune 周期任务检测 Cursor、Claude Code、Codex 与 Windsurf 配置。</span></li><li><b>加载基线</b><span>为受管项目增量安装 Agent 规则，并持续扫描 Skill、MCP 与代码。</span></li><li><b>联动处置</b><span>以 device_id 关联<EDR_VENDOR_CN> EDR 与<MDM_VENDOR_CN>资产，按风险等级分级响应。</span></li></ol>
              ...
              <p className="safety-note"><LockKeyhole size={15}/>部署脚本不包含<EDR_VENDOR_CN>或<MDM_VENDOR_CN>管理凭据；正式联动需按现网版本申请服务账号与接口授权。</p>
            </div>
          </>
        )}
        {scanner && (
