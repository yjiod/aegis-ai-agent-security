        ...
        {view === 'onboarding' && (
          <>
            ...
            <div className="panel inset onboarding">
              ...
              <ol><li><b>试点部署</b><span>先向 Intune 测试设备组下发，验证检测与修复脚本。</span></li><li><b>联动映射</b><span>以设备名、用户和 Sentinel device_id 关联 EDR 与<MDM_VENDOR_CN>资产。</span></li><li><b>分级放量</b><span>观察模式 → 高危阻断 → 全员强制，保留回滚窗口。</span></li></ol>
