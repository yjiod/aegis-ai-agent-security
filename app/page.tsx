          ...
          <>
            ...
            <div className="panel inset onboarding">
              ...
              <div className="download-actions">
                ...
                <a className="download-primary" href="https://github.com/yjiod/sentinel-ai-agent-security/releases/download/v5.6.0/Sentinel-Agent-Windows-x64-5.6.0.msi">Windows MSI 5.6</a>
                <a className="download-primary" href="https://github.com/yjiod/sentinel-ai-agent-security/releases/download/v5.6.0/Sentinel-Agent-macOS-5.6.0.pkg">macOS PKG 5.6</a>
                <a href="https://github.com/yjiod/sentinel-ai-agent-security/releases/download/v5.6.0/SHA256SUMS.txt">安装包 SHA-256</a>
