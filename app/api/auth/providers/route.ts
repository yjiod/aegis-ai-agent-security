 ...
 * - uac:   传音用户中心 (<CORP_NAME> UAC) SSO. Enabled when
...
export async function GET(request: Request) {
  ...
  if (uacEnabled) {
    ...
    // UAT portal carries a port, e.g. https://<UAC_UAT_DOMAIN>:10201/#/c-login
    const portal = process.env.AEGIS_UAC_PORTAL || 'https://<UAC_DOMAIN>/#/c-login';
