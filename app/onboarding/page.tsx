...
const controlPlanes = [
  ...
  {
    name: '<EDR_VENDOR_CN> EDR',
    role: '响应处置',
    desc: '接收高危事件，按现网版本能力执行隔离、查杀或 IOC 取证。',
  },
  {
    name: '<MDM_VENDOR_CN>桌管',
    role: '资产与兜底',
...
const orchestrationSteps = [
  ...
  {
    title: '联动处置',
    desc: '以 device_id 关联<EDR_VENDOR_CN> EDR 与<MDM_VENDOR_CN>资产，按风险等级分级响应。',
  },
];
  ...
  return (
    <section className="workspace">
      <div className="demo-notice" role="note">
        ...
        <span>
          <strong>演示模式</strong>
          部署编排、控制面联动与下载清单均为界面样例；正式接入前请以现网 Intune、<EDR_VENDOR_CN> EDR 与<MDM_VENDOR_CN>桌管版本核对脚本与接口授权。
        </span>
      </div>
      ...
      <div className="page-head animate-entrance animate-entrance-1">
        ...
        <div className="head-actions">
          <Button
            variant="outline"
            onClick={() =>
              setToast('演示模式：发行通道固定为 Intune + <MDM_VENDOR_CN>桌管，未切换。')
            }
          >
            <ChevronDown />
            Intune 发行通道
      ...
      <div className="panel onboarding">
        ...
        <p className="safety-note">
          <LockKeyhole size={15} />
          部署脚本不包含<EDR_VENDOR_CN>或<MDM_VENDOR_CN>管理凭据；正式联动需按现网版本申请服务账号与接口授权。
        </p>
      </div>
    </section>
  );
