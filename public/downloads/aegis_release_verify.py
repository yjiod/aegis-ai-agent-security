...
BUNDLE_FILES=(
    "aegis_macos_desktop_status.py",
    "aegis_macos_lifecycle.py",
    "aegis_macos_runtime_activation.py",
    "aegis_macos_user_retirement.py", "retire-aegis-user-macos.sh",
    "aegis_macos_service_migration.py",
