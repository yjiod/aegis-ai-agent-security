...
def remediation_recommendation(row,required_agent="0.45.0",required_policy="5.1.0"):
...
def collector_recommendations(db_path,limit=200,required_agent=None,required_policy=None):
    limit=min(max(int(limit),1),200); required_agent=required_agent or required_version("SENTINEL_REQUIRED_AGENT_VERSION","0.45.0"); required_policy=required_policy or required_version("SENTINEL_REQUIRED_POLICY_VERSION","5.1.0")
    with db_open(db_path) as db:
...
def collector_summary(db_path,now=None,active_window=86400,required_agent=None,required_policy=None):
    ...
    versions={"current":0,"agent_mismatch":0,"policy_mismatch":0,"both_mismatch":0,"unknown":0}; required_agent=required_agent or required_version("SENTINEL_REQUIRED_AGENT_VERSION","0.45.0"); required_policy=required_policy or required_version("SENTINEL_REQUIRED_POLICY_VERSION","5.1.0")
