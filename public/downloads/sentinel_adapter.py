#!/usr/bin/env python3
"""Vendor-neutral adapter boundary for <EDR_VENDOR> EDR and <MDM_VENDOR>. Disabled by default."""
...
def process(report,config,dry_run=False):
    outputs=[]
    for name,builder in [("<edr_vendor>",<edr_vendor>_event),("<mdm_vendor>",<mdm_vendor>_posture)]:
