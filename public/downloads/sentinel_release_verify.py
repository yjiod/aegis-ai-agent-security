...
BUNDLE_FILES=(
    ...
    "sentinel-adapters.example.json","sentinel_release_verify.py","sentinel_collector_backup.py","sentinel_collector_restore.py","sentinel_vendor_probe.py","sentinel_vendor_evidence_sign.py","sentinel_vendor_keyring.py","sentinel_production_preflight.py","sentinel_production_evidence_prepare.py","sentinel_production_evidence_sign.py","sentinel_production_keyring.py","production-acceptance-evidence.example.json",
...
def verify(downloads):
    ...
    for directive in ("private_atomic_output","canonical_unsigned","validate_unsigned","production_gate_not_approved","production_record_mismatch:","production_approval_record_mismatch:","stale_or_future_evidence","production_signing_key_unavailable","secrets_embedded","--evidence-root","--keyring"):
