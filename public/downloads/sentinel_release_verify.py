...
BUNDLE_FILES=(
    ...
    "sentinel-adapters.example.json","sentinel_release_verify.py","sentinel_collector_backup.py","sentinel_collector_restore.py","sentinel_vendor_probe.py","sentinel_vendor_evidence_sign.py",
...
def verify(downloads):
    ...
    if enablement!={"evidence_schema":"sentinel.vendor-acceptance/v3","signing_input_schema":"sentinel.vendor-acceptance/v2","integrity_algorithm":"hmac-sha256","signing_secret_env":"SENTINEL_VENDOR_ACCEPTANCE_SIGNING_SECRET","offline_signing_keyring_argument":"--keyring","offline_signing_output_argument":"--output","offline_signing_output_semantics":"private_fsync_atomic_replace_directory_fsync","verification_keyring_env":"SENTINEL_VENDOR_ACCEPTANCE_SIGNING_KEYS","verification_keyring_file_env":"SENTINEL_VENDOR_ACCEPTANCE_SIGNING_KEYS_FILE","maximum_verification_keys":5,"maximum_verification_keyring_bytes":65536,"live_probe_schema":"sentinel.vendor-probe/v1","maximum_probe_age_seconds":86400,"maximum_evidence_age_seconds":604800,"required_for":["sangfor","leagsoft"],"secrets_allowed":False}: errors.append("vendor_enablement_contract_drift")
