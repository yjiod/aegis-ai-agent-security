...
def verify(downloads):
    ...
    if release.get("component_versions")!={"endpoint_agent":"0.49.0","policy":"5.1.0","collector":"0.26","adapter":"0.19"}: errors.append("release_component_version_drift")
    ...
    for directive in ("Sentinel AI Agent Security Host","SentinelAIAgentSecurity","Stop-Service","WaitForStatus","sc.exe delete","SentinelAgent-Uninstall-Evidence","refusing recursive removal","Quarantine evidence and disabled user objects remain"):
