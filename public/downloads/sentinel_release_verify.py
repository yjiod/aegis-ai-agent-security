...
def verify(downloads):
    ...
    if release.get("component_versions")!={"endpoint_agent":"0.38.0","policy":"4.9.0","collector":"0.19","adapter":"0.18"}: errors.append("release_component_version_drift")
