...
def verify(downloads):
    ...
    for directive in ("sentinel.device-enrollment/v2","valid_report_url","300<=ttl<=86400","consume_once","expires_at"):
    ...
    if openapi.get("openapi")!="3.1.0" or openapi.get("info",{}).get("version")!="0.24.0": errors.append("collector_openapi_version_drift")
