...
def verify(downloads):
    ...
    if release.get("component_versions")!={"endpoint_agent":"0.44.0","policy":"5.1.0","collector":"0.20","adapter":"0.19"}: errors.append("release_component_version_drift")
