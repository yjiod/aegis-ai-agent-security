...
def check_write(base,token,secret,device_id):
    ...
    now=int(time.time()); report={"schema":"sentinel.report/v1","agent_version":"0.50.0","policy_version":"5.1.0","device_id":device_id,"scanned_at":now,"summary":{"critical":0,"high":0,"medium":0,"low":0},"findings":[]}
