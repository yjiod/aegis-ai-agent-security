...
def check_read_only(base,token):
    ...
    required={"generated_at","active_window_seconds","required_agent_version","required_policy_version","total_devices","active_devices","stale_devices","latest_severity","version_posture","credential_posture"}
...
def check_write(base,token,secret,device_id):
    ...
    now=int(time.time()); report={"schema":"sentinel.report/v1","agent_version":"0.30.0","policy_version":"4.8.0","device_id":device_id,"scanned_at":now,"summary":{"critical":0,"high":0,"medium":0,"low":0},"findings":[]}
