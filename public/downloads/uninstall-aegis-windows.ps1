...
Write-Output 'Aegis runtime and managed user baseline blocks removed. Repository rule files are retained for audit and must be removed through source control.'
