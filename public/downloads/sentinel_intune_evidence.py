...
def build(downloads,base,intune,collector,now=None):
    ...
    if not isinstance(intune,dict) or not ((intune.get("schema")=="sentinel.intune-export/v1" and set(intune)==v1) or (intune.get("schema")=="sentinel.intune-export/v2" and set(intune)==v2)): raise ValueError("invalid_intune_export")
    ...
    if intune["schema"]=="sentinel.intune-export/v1":
