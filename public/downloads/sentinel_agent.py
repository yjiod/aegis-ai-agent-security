...
def sync_policy(path,report_url,token,verification_keys,timeout=10):
    ...
    endpoint=f"https://{parsed.netloc}/v1/policy"; request=urllib.request.Request(endpoint,headers={"Authorization":"Bearer "+token,"Accept":"application/json","User-Agent":"SentinelAgent/0.48.0"})
...
def report_headers(body,token="",secret="",now=None,device_id=""):
    headers={"Content-Type":"application/json","User-Agent":"SentinelAgent/0.48.0"}
